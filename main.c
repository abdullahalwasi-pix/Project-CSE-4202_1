...
)
{
    ...
    /*
        Deleted course-এর result বাদ দেওয়া হচ্ছে।

        Deleted course-এর পরের course-গুলোর address
        এক ঘর আগে চলে যাবে। তাই result-এর course
    ...
    *n_results = kept_results;
    ...
    /*
        Course array থেকে selected course সরিয়ে
        পরের course-গুলো এক ঘর সামনে আনা হচ্ছে।
    */
